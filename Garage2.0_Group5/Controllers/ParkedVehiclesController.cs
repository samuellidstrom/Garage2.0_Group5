...
namespace Garage2._0_Group5.Controllers
{
    public class ParkedVehiclesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Type,Color,Brand,NumberOfWheels,TimeAtCheckIn")] ParkedVehicle parkedVehicle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,Type,Color,Brand,NumberOfWheels,TimeAtCheckIn")] ParkedVehicle parkedVehicle)
        {
