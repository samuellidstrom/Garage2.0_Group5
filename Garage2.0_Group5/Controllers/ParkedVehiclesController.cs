...
namespace Garage2._0_Group5.Controllers
{
    public class ParkedVehiclesController : Controller
    {
        ...
        public ParkedVehiclesController(Garage2_0_Group5Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,VehicleType,RegistrationNumber,Color,VehicleBrand,VehicleModel,NumberOfWheels,TimeAtCheckOut")] ParkedVehicle parkedVehicle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,VehicleType,RegistrationNumber,Color,VehicleBrand,VehicleModel,NumberOfWheels,TimeAtCheckOut")] ParkedVehicle parkedVehicle)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Garage2_0_Group5Context.ParkedVehicle'  is null.");
            }
            var parkedVehicle = await _context.ParkedVehicle.FindAsync(id);
            if (parkedVehicle != null)
            {
